...
# Place the dropdowns in separate columns with unique keys
selected_ticker = col1.selectbox('Select Brokerage:', options=data['FirmName'].unique(), key='select_brokerage')
selected_metric = col2.selectbox('Select Metric:', options=['Volume', 'Value', 'Frequency'], key='select_metric')
