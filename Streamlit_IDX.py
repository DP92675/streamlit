...
st.markdown('<h2 style="font-size:24px;">Indonesian Brokerage Benchmarking</h2>', unsafe_allow_html=True)
...
st.markdown(f'<h2 style="font-size:20px;">{selected_ticker1}: {selected_metric} </h2>', unsafe_allow_html=True)
st.empty()
st.plotly_chart(plot_chart(selected_ticker1, selected_metric, max_y, max_yoy))
st.empty()
st.markdown(f'<h2 style="font-size:20px;">{selected_ticker2}: {selected_metric} </h2>', unsafe_allow_html=True)
st.empty()
